            ...
            <div className="md:w-11/12 w-full mx-auto bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <div className="p-8">
                    ...
                    <div className="flex items-center justify-between mb-6">
                        {/* // Profile title */}
                        <h1 className="text-3xl text-center font-bold text-gray-900">Profile</h1>
                            ...
                            />
                            {
                                isEditing && (
                                    <div className="relative mt-4">
                                        <button className="mb-4 w-32 bg-blue-600 text-white h-10 border border-gray-300 rounded-md absolute top-0 left-0">Upload</button>
                                        <input type="file" onChange={handleImageChange} className="mb-4 w-32 h-10 border border-gray-300 rounded-md absolute opacity-0 top-0 left-0" />
                                    </div>
                                )
                            }
                        </div>
                        ...
                        <div className="flex-grow">
                            ...
                            {isEditing ? (
                                <input
                                    ...
                                    className="text-xl font-semibold mb-2 w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                />
                            ) : (
                                <h2 className="text-2xl font-semibold mb-2">{userInfo.username}</h2>
                            )}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg">
                            ...
                            <p className="text-3xl font-bold text-orange-600">{userQuizzes.length}</p>
                        </div>
                    </div>
